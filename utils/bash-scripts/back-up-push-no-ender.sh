...
rsync -aAXv --exclude 'node_modules/' --exclude 'workspace/liveramp/aws' --exclude 'workspace/liveramp/github' --exclude 'workspace/open-law-lib/oll/' --exclude 'venv/' --exclude 'ender/' --delete ~/documents/ /mnt/sanDisk/back-up/documents/
