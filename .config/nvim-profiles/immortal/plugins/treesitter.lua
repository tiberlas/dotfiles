...
treesitter_configs.setup {
	...
	ensure_installed = { "c", "lua", "bash", "css", "vim", "vimdoc", "query", "fish", "git_config", "gitignore", "html",
		"javascript", "json", "python", "scss", "typescript" },
	...
	incremental_selection = {
		enable = true,
		keymaps = {
			init_selection = '<leader>av',
			node_incremental = '<leader>av',
			scope_incremental = '<leader>ap',
			node_decremental = '<leader>au',
		},
	},
	textobjects = {
		select = {
