...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist = awful.widget.taglist {
        ...
        style = {fg_focus = '#3eb489dd', bg_focus = '#00000000'}
    }
...
end, {description = "restore minimized", group = "client"}), -- Dmenu
awful.key({modkey}, "r", function() awful.util.spawn("dmenu_run") end,
          {description = "run dmenu", group = "launcher"}), -- Screen config
awful.key({modkey, "Shift"}, "s", function()
    awful.util.spawn("bash /home/t.tapai/.dmenu/monitor-settings.sh")
end, {description = "run screen config", group = "launcher"}), -- Emoji ;)
...
clientkeys = gears.table.join(awful.key({modkey}, "f", function(c)
    ...
    c:raise()
                              ...
                              awful.key({modkey}, "left mouse click",
                                        function() end, {
    description = "move focused client",
    group = "client"
}), awful.key({modkey}, "right mouse click", function() end,
