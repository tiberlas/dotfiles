...
plugins=(git sudo history zsh-autosuggestions zsh-syntax-highlighting zsh-abbr)
#plugins=(git z zsh-autosuggestions zsh-syntax-highlighting zsh-abbr)
...
#abbr -g console="npm run serve --profile=factor-dev-profile --env="
#abbr -g open="mimeopen -d"
#abbr -g r-on="redshift -O 5000K"
#abbr -g r-off="redshift -O 6500K"
#abbr -g clock="tty-clock -scbx -C 1 -f \"%a, %d %b %Y %T\""
#abbr -g rig="neofetch"
...
factor-env () {
   npm run serve --proflile=factor-dev-profile --env=$1
}
